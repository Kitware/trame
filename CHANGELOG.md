...
- Add libraries to RTD
  ([`834aa0b`](https://github.com/Kitware/trame/commit/834aa0b6d0e9f40eb58b2009019096b77644511b))

Add trame-tauri, trame-gwc and trame-dockview to RTD

- Migrate from setup tools to hatchling
  ([`af07621`](https://github.com/Kitware/trame/commit/af07621c5028699001a50f6630dcb2d975020150))

- Remove MANIFEST.in
  ([`23f040a`](https://github.com/Kitware/trame/commit/23f040a9d0b129039f79b2ce2fc47e145273244e))

- **deps-dev**: Bump postcss from 8.5.14 to 8.5.25 in /docs/vitepress
  ([`4145270`](https://github.com/Kitware/trame/commit/4145270901bb3637a120e72986ddc884a64d6307))

Bumps [postcss](https://github.com/postcss/postcss) from 8.5.14 to 8.5.25. - [Release
...
--- updated-dependencies: - dependency-name: postcss dependency-version: 8.5.25
...
- **tools**: Move profiler back into tools
  ([`0ebae61`](https://github.com/Kitware/trame/commit/0ebae613dba50f2b5a269493d14d8a29ea3f862d))

### Code Style

- Use python warnings library
  ([`a99da1c`](https://github.com/Kitware/trame/commit/a99da1cb7c7aa53545ecc2727fd2dee6ac95a52f))

### Continuous Integration

- Fetch more badges
  ([`3a35688`](https://github.com/Kitware/trame/commit/3a35688935f593fb18d6896ae9b058e7ec0692f1))

- Pre-fetch download badge
  ([`e902ff1`](https://github.com/Kitware/trame/commit/e902ff1ff308aa3afa99e57bd4ac197daf2fc457))

- Update schedule to skip rate limit
  ([`1ec3d66`](https://github.com/Kitware/trame/commit/1ec3d66d7a264c8fcc1f61d54c60a62f47dc32af))

### Documentation

- Add trame news for new radial menu widget
  ([`c979016`](https://github.com/Kitware/trame/commit/c979016578ca447da3ff84bce1497ec347bb8243))

- Add trame-catalyst
  ([`4b751bd`](https://github.com/Kitware/trame/commit/4b751bd7aa23e48c9ef5211fca95007ecbaf266d))

- Add trame-flow
  ([`48ff164`](https://github.com/Kitware/trame/commit/48ff164c256ade85685fc1d8f669483769d8f5c2))

- Retroactively add trame-gwc news
  ([`0ad03ca`](https://github.com/Kitware/trame/commit/0ad03ca1baae5077fc57ef59bd26e6cc708e8212))

- Update jupyter doc
  ([`c1e5530`](https://github.com/Kitware/trame/commit/c1e55303ffeaa78d9d0613d463248b486fac5db6))

- Update Jupyter doc with display_cell trame-client API

- Update wasm
  ([`3da377f`](https://github.com/Kitware/trame/commit/3da377fa2d184ffaf4fab74e7602c8e9c17d7550))

- **api**: Add profiler tool
  ([`1c77822`](https://github.com/Kitware/trame/commit/1c77822517866a219d05f5ee46c3521fe2003929))

- **app**: Add more apps in listing
  ([`aa0aaca`](https://github.com/Kitware/trame/commit/aa0aaca3bfcc5d099f921a5ee920f61ee7af6f52))

- **app**: Improve tags
  ([`9d8b6b9`](https://github.com/Kitware/trame/commit/9d8b6b92be9a5a9b35029ba3e80bb64fbc56df85))

- **apps**: Update community apps
  ([`cbbc436`](https://github.com/Kitware/trame/commit/cbbc4361cbed42ca8504d34a7313f0f020b16941))

- **badge**: Cache download badge
  ([`c2b18d5`](https://github.com/Kitware/trame/commit/c2b18d5def90a1308f423ce7a7ebdc3ef44c84c0))

- **badge**: Fix path
  ([`11bec95`](https://github.com/Kitware/trame/commit/11bec95e819336bbdb354298760d2da20cc92338))

- **catalog**: Fix URL in external_repos.yml after change of repo name
  ([`8289922`](https://github.com/Kitware/trame/commit/82899224108f2c91cf6904fd1eff593c0898076e))

SAGE-Viewer is now ViSAGE so the provided URL was different from the fetched one. The URL is updated
  and an explicit error message is added in case this happens again.

Ref: https://github.com/Kitware/trame/actions/runs/30020617488/job/89252053964

- **catalogs**: Add download of remote images to serve them itself
  ([`674af94`](https://github.com/Kitware/trame/commit/674af9497daab1b693db14c8a3d6d61a4c358f18))

- **catalogs**: Cache downloaded images
  ([`d5007d0`](https://github.com/Kitware/trame/commit/d5007d021f4af0b25ddf314e0865e0e39f8db411))

This prevents 900s retry waits when hitting github servers too often with download requests

- **catalogs**: Change non-kitware repo emoji and action on click topic
  ([`7fe99ae`](https://github.com/Kitware/trame/commit/7fe99aee0aae7a0bc44611a13f115fb5ecc40d4c))

The text on top of the page for the emoji meaning is removed and the emoji is now less worrying. Now
  clicking a topic will toggle its filtering instead of redirecting to the github topic page.

- **catalogs**: Fix missing apps and add logs
  ([`11c52c3`](https://github.com/Kitware/trame/commit/11c52c3227a22f457a6d6b4fcc73999cf46ffb1b))

- **catalogs**: Make the fetching of repos use warning to skip not found repos
  ([`a1e1100`](https://github.com/Kitware/trame/commit/a1e1100af78d1e9779e678f82e33ffbe8a30e870))

Also increase the number of fetched topics

- **examples**: Improve website
  ([`24dc27e`](https://github.com/Kitware/trame/commit/24dc27efa6b2b177af5050b91c18e2adffeb0d79))

- **llms**: Add text file for llms
  ([`937d342`](https://github.com/Kitware/trame/commit/937d342adb3886b1a1259ba80124d19697667ae8))

- **news**: Add note for client.Handler
  ([`c6df341`](https://github.com/Kitware/trame/commit/c6df3416ea5abf2311cc5ef3337faaa9c607ea4d))

- **news**: Add Widgets and Applications catalogs in news
  ([`3333070`](https://github.com/Kitware/trame/commit/3333070a266fe68ea135d0527b6fd25e7ddd5d03))

- **website**: Fix relative path in jupyter guide
  ([#889](https://github.com/Kitware/trame/pull/889),
  [`bde3394`](https://github.com/Kitware/trame/commit/bde3394f4d47c2cc534d639adc7def857c4d703d))

- **website**: Improve content
  ([`a50c006`](https://github.com/Kitware/trame/commit/a50c00690da1bdde805e5198cffad8a3448ce04d))

- **website**: Improve introduction content
  ([`ddd1999`](https://github.com/Kitware/trame/commit/ddd1999d607627360a21a12889ee5d7ef7403787))

- **website**: Update life_cycle page
  ([`a0afa8a`](https://github.com/Kitware/trame/commit/a0afa8a6df23cb32034b6ff8cb8d20937142669e))

- **widgets**: Add the trame-radial-menu widget
  ([`a481d29`](https://github.com/Kitware/trame/commit/a481d2961b6288e1e77fe6e878e07624a43d9a89))

- **widgets**: Add trame-flow
  ([`5950802`](https://github.com/Kitware/trame/commit/59508021c1b12ee21f8f18bc922a37dc4a1c8c0f))

- **widgets**: Change trame-radial-menu's tooltip
  ([`eb94f06`](https://github.com/Kitware/trame/commit/eb94f06108870bf8ecc4834c8f123e1d9ab4a91c))

- **wigets**: List widgets and apps automatically
  ([`414a110`](https://github.com/Kitware/trame/commit/414a110552384a0d0a36505e22cc75de0aa411ff))

### Features

- **v4**: Bump dependencies to enable react
  ([`824f074`](https://github.com/Kitware/trame/commit/824f0744718850d5266c51a8241da7e6659219f2))
