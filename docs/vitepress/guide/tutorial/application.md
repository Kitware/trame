...
![Example Application](/assets/images/tutorial/example.jpg)
...
![Example Application Toolbar](/assets/images/tutorial/toolbar.jpg)
...
![Example Application Drawer](/assets/images/tutorial/drawer.jpg){ width=35% }
...
![Pipeline Widget](/assets/images/tutorial/pipeline-widget.jpg){ width=50% }
...
![Default GUI Card](/assets/images/tutorial/gui-card.jpg){ width=50% }
...
![Mesh Card](/assets/images/tutorial/mesh-card.jpg){ width=50% }
...
![Contour Card](/assets/images/tutorial/contour-card.jpg){ width=50% }
...
![Color By Selection](/assets/images/tutorial/gui-color-by.jpg){ width=25% }
...
![Color Map Selection](/assets/images/tutorial/gui-color-map.jpg){ width=25% }
...
![Opacity Slider](/assets/images/tutorial/gui-opacity.jpg){ width=50% }
...
![Contour By Selection](/assets/images/tutorial/gui-contour-by.jpg){ width=50% }
...
def update_mesh_representation(self, mesh_representation, **_):
...
def update_contour_representation(self, contour_representation, **_):
...
def update_mesh_color_by_name(self, mesh_color_array_idx, **_):
...
def update_contour_color_by_name(contour_color_array_idx, **_):
...
def update_mesh_color_preset(self, mesh_color_preset, **_):
...
def update_contour_color_preset(self, contour_color_preset, **_):
...
# Opacity Callbacks
@change("mesh_opacity")
def update_mesh_opacity(self, mesh_opacity, **_):
...
def update_contour_opacity(self, contour_opacity, **_):
...
def update_contour_by(self, contour_by_array_idx, **_):
...
def update_contour_value(self, contour_value, **_):
